(defpackage #:inga/test/helper
  ...
  (:import-from #:inga/ast-index
                ...
                #:create-indexes
                #:get-ast)
  (:import-from #:inga/ast-index/memory
                #:ast-index-memory)
...
(def-fixture jvm-ctx (root-path &key (index-type 'ast-index-memory) (include '("**")))
...
(def-fixture node-ctx (root-path &key (index-type 'ast-index-memory) (include '("**")))
  (defparameter *root-path* root-path)
  (defparameter *index* nil)
  (setf *index* (make-instance index-type
                               :root-path root-path))
