...
(test get-diff-of-one-line
  (is (equal '((("path" . "src/functions.ts") ("start" . 6) ("end" . 6)))
             (inga:get-diff *project-path* "a690a51" *include* "dc33553"))))
...
(test get-diff-of-multiple-lines
  (is (equal '((("path" . "src/App/NewTodoInput/index.tsx") ("start" . 15) ("end" . 16))
             ...
             (inga:get-diff *project-path* "a690a51" *include* "4b0399f"))))
...
(test get-diff-of-multiple-files
  (is (equal '((("path" . "src/App/NewTodoInput/index.tsx") ("start" . 14) ("end" . 14))
             ...
             (inga:get-diff *project-path* "a690a51" *include* "3a2d509"))))

(test not-get-diff-with-exclude
  (is (equal '()
             (inga:get-diff *project-path* "a690a51" *include* "b4ac09c" '("*.test.tsx")))))

(test not-get-diff-with-delete-file
  (is (equal '()
             (inga:get-diff *project-path* "a690a51" *include* "9f17b4c" '("*index.tsx")))))
